...
class TestLinkedList(unittest.TestCase):
    ...
    def test_append_and_prepend(self):
        ...
        self.assertEqual(ll.tail.value, "A")
        self.assertEqual(ll.count, 1)
    ...
    def test_delete_head(self):
        ll = LinkedList()
        self.assertRaises(ValueError, ll.delete_head)
        self.assertIsNone(ll.head)
        self.assertIsNone(ll.tail)
        self.assertEqual(ll.count, 0)
        for i in range(15):
    ...
    def test_delete_tail(self):
        ll = LinkedList()
        self.assertRaises(ValueError, ll.delete_tail)
        self.assertIsNone(ll.head)
        self.assertIsNone(ll.tail)
        self.assertEqual(ll.count, 0)
    ...
    def test_delete_special_cases(self):
        ll = LinkedList()
